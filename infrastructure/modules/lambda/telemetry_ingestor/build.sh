...
SRC_DIR="${REPO_ROOT}/src/lambdas/telemetry_ingestor"
TF_MODULE_DIR="${REPO_ROOT}/infrastructure/modules/lambda/telemetry_ingestor"

REQ_FILE="${SRC_DIR}/requirements.txt"
PY_FILE="${SRC_DIR}/ingestor_lambda.py"
