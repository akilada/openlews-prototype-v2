    ...
    test_cases = [
        {
            ...
            "event": {"action": "nearest", "latitude": 6.92, "longitude": 80.98},
        },
        {
        ...
        },
        {
            ...
            "event": {"action": "nearest", "latitude": 6.9889, "longitude": 81.0544},
        },
        {
            "name": "Find Nearest Zone (Haldummulla)",
            "event": {"action": "nearest", "latitude": 6.7833, "longitude": 80.9000},
        },
    ]
        ...
        try:
            ...
            if status_code == 200:
                ...
                if "nearest_zone" in body:
                    ...
                    print(
                        f"   Location: {zone['centroid']['lat']:.4f}, {zone['centroid']['lon']:.4f}"
                    )
...
def test_deployed(
    function_name: str = "openlews-dev-rag-query", region: str = "ap-southeast-2"
):
...
def main():
    ...
    parser.add_argument(
        "--function-name",
        default="openlews-dev-rag-query",
