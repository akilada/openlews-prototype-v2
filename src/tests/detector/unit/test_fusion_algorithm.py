...
class TestFusionAlgorithm:
    ...
    def test_spatial_correlation_isolated_anomaly(self):
        ...
        assert correlation < 0.3, f"Expected low correlation for isolated anomaly, got {correlation}"
    ...
    def test_composite_risk_boost(self):
        ...
        composite = self.fusion.calculate_composite_risk(individual_risk, high_correlation)
    ...
    def test_composite_risk_reduction(self):
        ...
        composite = self.fusion.calculate_composite_risk(individual_risk, low_correlation)
